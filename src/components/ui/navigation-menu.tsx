...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion=from-end]:slide-in-from-right-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out top-0 left-0 min-w-20 p-2 pr-2.5 data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out min-[640px]:absolute",
