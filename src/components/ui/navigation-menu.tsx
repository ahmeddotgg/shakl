...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        "group flex justify-center items-center list-none",
        className
      )}
      {...props}
    />
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "top-0 data-[motion=from-end]:slide-in-from-right-52 data-[motion=to-end]:slide-out-to-right-52 left-0 data-[motion=to-start]:slide-out-to-left-52 min-[640px]:absolute data-[motion=from-start]:slide-in-from-left-52 p-2 pr-2.5 min-w-20 data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out",
